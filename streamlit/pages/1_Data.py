...
def housing(df):
    ...
    st.dataframe(df)
    st.divider()
    st.write("When I was exploring the data, I found that our outcome variable, *saleprice* was very skewed. This isn't good because a linear model requires non-skewed data to work properly!")
