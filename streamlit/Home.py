...
st.markdown(
    """
### Overview
This app demonstrates various data science and machine learning techniques applied to multiple datasets. 
Below is a brief summary of each dataset, and some practical applications.
...
### Prediction
- **Titanic**: Passenger survival status is predicted based on Age, Sex, Fare, Number of Parents, Number of Children, 
    Marriage Status, Number of Siblings, and Class (1st, 2nd, or 3rd).
- **Ames Housing**: House price of a home in Ames, Iowa, between 2006 and 2010 is predicted, 
    using Quality, Condition, Exterior Quality, Basement SF, Central Air, Living Area, and Number of Fireplaces.
